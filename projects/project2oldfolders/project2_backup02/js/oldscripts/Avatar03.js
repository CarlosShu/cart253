class Avatar {
  ...
  collide(ground) {
    ...
    // Collides with Rectangle.
    let dplatform = dist(this.x, this.y, rectangle.x, rectangle.y);
    // This makes it collide from the left side.
    if (
      this.x < rectangle.x - rectangle.width / 2 &&
      this.x < rectangle.x + rectangle.width / 2 &&
      drectangle < this.width / 2 + rectangle.width / 2 &&
      drectangle < this.height + rectangle.height &&
      this.vx == this.speed
    ) {
      this.vx = 0;
      // This makes it collide from the Right side.
    } else if (
      this.x > rectangle.x - rectangle.width / 2 &&
      this.x > rectangle.x + rectangle.width / 2 &&
      drectangle < this.width / 2 + rectangle.width / 2 &&
      ...
      this.vx = 0;
      // This makes it collide from the top.
    } else if (
      this.x > rectangle.x - rectangle.width / 2 &&
      this.x < rectangle.x + rectangle.width / 2 &&
      ...
      // This makes it collide from the bootom.
    } else if (
      this.x > rectangle.x - rectangle.width / 2 &&
      this.x < rectangle.x + rectangle.width / 2 &&
