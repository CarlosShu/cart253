...
function setup() {
  ...
  canonball = new Canonball(1400, 480, 50, 50, 0, 12, -100, 1400);
  canonball02 = new CanonballRight(200, 280, 50, 50, 0, 12, 1700, 200);
...
function level06() {
  ...
  platform = new Platform(150, 250, 100, 55);
  platform.display();
...
function level07() {
  ...
  platform = new Platform(1200, 220, 100, 55);
  platform.display();

  platform02 = new Platform(350, 445, 100, 55);
  platform02.display();
