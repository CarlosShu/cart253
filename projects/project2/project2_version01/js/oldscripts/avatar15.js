class Avatar {
  ...
  collide() {
    ...
    // Collides with Big door.
    if (state == "tutorial") {
      if (
        this.x > doorbig.x - doorbig.width / 3 &&
        this.x < doorbig.x + doorbig.width / 3 &&
        this.y > doorbig.y - doorbig.height / 1 &&
        this.y < doorbig.y + doorbig.height / 1.5
      ) {
        if (doorlock == false) {
          exit = true;
        }
    ...
    if (state == "tutorial") {
      // Collides with largeplatformwidetall01.
      let dlargeplatformwidetall01 = dist(
        this.x,
        this.y,
        largeplatformwidetall01.x,
        largeplatformwidetall01.y
      );
      if (
        this.x <
          largeplatformwidetall01.x - largeplatformwidetall01.width / 1.9 &&
        this.x <
          largeplatformwidetall01.x + largeplatformwidetall01.width / 1.9 &&
        dlargeplatformwidetall01 <
          this.width / 1.9 + largeplatformwidetall01.width / 1.9 &&
        dlargeplatformwidetall01 <
          this.height + largeplatformwidetall01.height &&
        this.vx == this.speed
      ) {
        this.vx = 0;
      } else if (
        ...
        this.x <
          largeplatformwidetall01.x + largeplatformwidetall01.width / 1.9 &&
        this.y <
          largeplatformwidetall01.y - largeplatformwidetall01.height / 2.2 &&
        this.y >
          largeplatformwidetall01.y - largeplatformwidetall01.height / 1.8
      ) {
        this.vy = 0;
        this.ay = 0;
        gravityForce = 0.0;
