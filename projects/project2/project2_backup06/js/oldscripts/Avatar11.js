class Avatar {
  ...
  collide(ground) {
    ...
    let dgroundblock01 = dist(this.x, this.y, groundblock01.x, groundblock01.y);
    if (
    ...
    let dgroundblock02 = dist(this.x, this.y, groundblock02.x, groundblock02.y);
    if (
    ...
    if (
      ...
      this.x > movingplatformvertical.x - movingplatformvertical.width / 1.75 &&
      this.x < movingplatformvertical.x + movingplatformvertical.width / 1.75 &&
